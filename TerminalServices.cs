...
namespace WindowsUtils.TerminalServices
{
    ...
    public class MessageBoxButton : MessageBoxOptions
    {
        ...
        public MessageBoxButton(uint value, string name) : base(value, name) { }
    }
    public class MessageBoxIcon : MessageBoxOptions
    {
        ...
        public MessageBoxIcon(uint value, string name) : base(value, name) { }
    }
    public class MessageBoxDefaultButton : MessageBoxOptions
    {
        ...
        public MessageBoxDefaultButton(uint value, string name) : base(value, name) { }
    }
    public class MessageBoxModal : MessageBoxOptions
    {
        public static MessageBoxModal MB_SYSTEMMODAL => new(0x00001000, "MB_SYSTEMMODAL");
        public static MessageBoxModal MB_TASKMODAL => new(0x00001000, "MB_TASKMODAL");

        public MessageBoxModal(uint value, string name) : base(value, name) { }
    }
    public class MessageBoxType : MessageBoxOptions
    {
        ...
        public MessageBoxType(uint value, string name) : base(value, name) { }
    }

    internal enum MessageBoxReturn : int
    {
        Ok = 1,
        Cancel = 2,
        Abort = 3,
