...
_NODISCARD static WuString WWuStringToMultiByte(const wchar_t* other, DWORD codePage)
{
    WuAllocator* allocator = new WuAllocator();
...
_NODISCARD static WuString WWuStringToNarrowMultiByte(const WWuString& other, DWORD codePage)
{
    WuAllocator* allocator = new WuAllocator();
